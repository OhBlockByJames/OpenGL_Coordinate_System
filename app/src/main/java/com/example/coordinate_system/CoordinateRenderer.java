...
public class CoordinateRenderer implements GLSurfaceView.Renderer {
    ...
    float xyzVertices[] = new float[]{
            ...
            0.5f,0.1f,0f,//2 x axis arrow 1
            0.5f,-0.1f,0f,//3 x axis arrow 2

            0f, -0.6f, 0f,//4 Y axis start
            0f, 0.6f, 0f,//5 Y axis end
            0.1f ,0.5f ,0f,//6 y axis arrow 1
            -0.1f ,0.5f ,0f,//7 y axis arrow 1

            0f, 0f, -0.6f,//8 Z axis start
            0f, 0f, 0.6f,//9 Z axis end
            0f ,0.1f ,0.5f,//10 Z axis arrow 1
            0f ,-0.1f ,0.5f,//11 Z axis arrow 2

            0.8f,0f,0f,//12 X label
            0.85f,0.1f,0f,//13
            0.75f,0.1f,0f,//14
            0.75f,-0.1f,0f,//15
            0.85f,-0.1f,0f,//16

            0f,0.7f,0f,//17 Y label
            0f,0.65f,0f,//18
            0.05f,0.75f,0f,//19
            -0.05f,0.75f,0f,//20

            -0.05f ,0.05f ,0.7f,//21 Z label
            0.05f,0.05f,0.7f,//22
            -0.05f,-0.05f,0.7f,//23
            0.05f,-0.05f,0.7f,//24
